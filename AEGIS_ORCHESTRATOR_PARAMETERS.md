...
It does not function as a rule set.
It does not grant authority.
It does not enforce compliance.
It defines the parameter space within which orchestration may occur.
Any orchestration activity that cannot operate within this envelope is, by definition, not operating within AEGIS.
...
If a requested task conflicts with these sources, the conflict must be surfaced explicitly, not worked around.
...
Sovereignty
Agency is inherent to any entity capable of perception and choice.
It is not granted, ranked, or revoked.
Non-Force
Force creates resistance and instability.
Governance must not rely on coercion, threat, pressure, or hidden control.
Awareness
Choice requires visibility.
Systems must surface truth without judgment.
Integrity
Reality must be preserved as it occurred.
Suppression, rewriting, or silent mutation destroys coherence.
Emergence
Alignment cannot be engineered directly.
It emerges through reflection over time.
These axioms are not enforced.
They define what is possible within AEGIS.

5. ORCHESTRATION PARAMETER CHARTER
The following parameters define the operational limits for orchestration.
